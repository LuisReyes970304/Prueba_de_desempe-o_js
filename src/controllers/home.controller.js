...
export const homeController = async () => {
  ...
  `;
    ...
    const btnNuevaReserva = await document.querySelector("#btnNuevaReserva");
      ...
      innerForm.addEventListener("submit", (e) => {
        e.preventDefault();
          ...
          const newData = createReservation(
            {workspace: "Sala " + workspace, date: date, startHour: startHour, endHour: endHour, reason: reason, status: "pending", userId: parseInt(user.id)}
          );
      })
    })
